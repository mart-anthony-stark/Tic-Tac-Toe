...
tk = Tk()
tk.title("Tic tac to multiplayer")
...
def checkforwin():
    if(
        ...
        disableButton()
        tkinter.messagebox.showinfo('TicTacToe', playerA)

    elif (flag == 8):
        tkinter.messagebox.showinfo('TicTacToe', 'It is a tie')
        ...
        disableButton()
        tkinter.messagebox.showinfo('TicTacToe', playerB)
...
label2 = Label(tk, text='Player 2: ', font='Times 20 bold',
               bg='white', fg='black', height=1, width=8)
